# Contributing to linkml-test

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-test. These guidelines are not strict rules.
...
The linkml-test team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the linkml-test technical leads
...
[issues]: https://github.com/pranjan77/linkml-test/issues/
[pulls]: https://github.com/pranjan77/linkml-test/pulls/
